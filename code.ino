...
const int motorREnable = 11; // enable pin for the right motor (needs to be PWM enabled)

const int motorLPin1 = 7; // signal pin 1 for the left motor, connect to IN3 (was 5 - need to change)             
...
const int irPins[6] = {13, 5, 4, 3, 2, 12};
...
//  }
  ...
  else if (motorRSpeed > 0) { // right motor forward (using PWM)
     analogWrite(motorREnable, motorRSpeed);
